...
FOOTER: process.env.FOOTER === undefined ? 'ultrabot v7 ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*created ʙʏ letovsky*' : process.env.CAPTION,
